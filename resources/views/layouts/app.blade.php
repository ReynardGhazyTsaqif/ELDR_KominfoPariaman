        ...
        <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
            ...
            <aside class="w-64 bg-[#061D38] text-white flex flex-col justify-between flex-shrink-0 transition-all duration-300 z-30 min-h-screen fixed top-0 bottom-0 left-0">
                <div>
                    ...
                    <div class="px-4 py-5">
                        <!-- CTA Button -->
                        <button type="button" class="w-full bg-[#F5BF38] hover:bg-[#E0AE2F] text-[#061D38] font-bold py-2.5 px-4 rounded-xl shadow-sm transition-all text-sm flex items-center justify-center gap-2 cursor-pointer mb-6">
                            <svg class="w-4 h-4 stroke-[2.5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2H7a2 2 0 01-2-2z" />
                            </svg>
            ...
            <div class="flex-1 pl-64 flex flex-col min-h-screen">
                ...
                <header class="bg-white border-b border-gray-200 sticky top-0 z-20 px-8 py-3.5 flex items-center justify-between shadow-xs">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="relative w-72">
                            <input type="text" placeholder="Cari dokumen atau user..." class="w-full bg-[#F0F4F8] text-sm text-gray-700 placeholder-gray-400 rounded-xl pl-10 pr-4 py-2 border-0 focus:outline-none focus:ring-2 focus:ring-[#061D38]/20">
                ...
                <footer class="px-8 py-4 bg-white border-t border-gray-200 flex items-center justify-between text-xs text-gray-500 font-medium">
                    <p>&copy; {{ date('Y') }} ELDR System - Diskominfo Kota Pariaman</p>
                    <div class="flex items-center gap-6 text-gray-500">
                        <a href="#" class="hover:text-gray-800 transition-all">Panduan Penggunaan</a>
                        <a href="#" class="hover:text-gray-800 transition-all">Hubungi Kami</a>
                    </div>
                </footer>
            </div>
        </div>
